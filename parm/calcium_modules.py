...
def calcium_extrusion_and_influx_single_mk():
    ...
    Expression(
        "k_Ca_cyt_to_extra",
        (Vmax_Ca_cyt_to_extra * (_Ca_cyt - Ca_C_0)**(n_Ca_cyt_to_extra-1)) / ((_Ca_cyt - Ca_C_0)**n_Ca_cyt_to_extra + Km_Ca_cyt_to_extra**n_Ca_cyt_to_extra),
    )  # 1/s
    alias_model_components()
    # cytosol to extracellular space
    Rule(
...
def gaq_activated_calcium_signaling_simplified():
    ...
    calcium_extrusion_and_influx_single_mk()
    ip3_degradation()
    return
