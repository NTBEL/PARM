...
# Gprotein activation using a precoupled mechanism:
gprotein_modules.precoupled_activation_mechanism()
receptor_modules.addon_minimal_twostate_precoupled_par2_activation()
