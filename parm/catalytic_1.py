...
follows:
  ...
  1. Single-state receptor activation of PAR2 by 2AT:
      2AT + PAR2_I <---> 2AT:PAR2_A
...
# Rate of 1e-5 molec/s reported by Yi et al. 2003 PNAS
# https://doi.org/10.1073/pnas.1834247100
# from fitting their model to FRET data.
Parameter('kcat_PAR2_activate_Gaq', 1e-5)
...
Rule('tat_bind_PAR2', TAT(b=None)**EXTRACELLULAR + PAR2(state='I', bortho=None, bgaq=None)**CELL_MEMB
     | tat_PAR2_a, kf_PAR2_bind_TAT,kr_PAR2_bind_TAT)
...
# Single-step catalytic reaction from yeast G protein cycle model
...
Observable("aGaq_ii", Gaq_gtp_RGS)
Observable("aGaq_iii", Gaq_gtp_RGS)
Observable("aGaq_iv", Gaq_gtp_PLC)
Expression("aGaq", aGaq_i + aGaq_ii - aGaq_ii + aGaq_iii + aGaq_iv)
