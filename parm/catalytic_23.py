...
# PySB macros
from pysb.macros import bind, bind_complex, catalyze, catalyze_complex, catalyze_state, degrade, equilibrate, synthesize
# NumPy
import numpy as np
...
Parameter('kf_PAR2_i_bind_TAT', KF_BIND)
...
Parameter('Kd_PAR2_i_bind_TAT', 142*nM_to_num_per_pL*Vcell.value)
Expression('kr_PAR2_i_bind_TAT', Kd_PAR2_i_bind_TAT*kf_PAR2_i_bind_TAT)
Parameter('kf_PAR2_a_bind_TAT', KF_BIND)
Parameter('Kd_PAR2_a_bind_TAT', 142*nM_to_num_per_pL*Vcell.value)
Expression('kr_PAR2_a_bind_TAT', Kd_PAR2_a_bind_TAT*kf_PAR2_a_bind_TAT)
Parameter('k_activate_PAR2', K_CONVERT*10)
Parameter('k_inactivate_PAR2', K_CONVERT/10)
# Assume that the inactive form is favored without the agonist.
Parameter('k_activate_PAR2_auto', K_CONVERT/10)
Parameter('k_inactivate_PAR2_auto', K_CONVERT*10)
# G protein recognition
Parameter('k_PAR2_bind_Gaq_i', KF_BIND/10)
Parameter('k_PAR2_bind_Gaq_il', KF_BIND/10)
Parameter('k_PAR2_bind_Gaq_a', KF_BIND)
Parameter('k_PAR2_bind_Gaq_al', KF_BIND)
# GDP release
Parameter('k_gdp_release_i', K_CONVERT/10)
Parameter('k_gdp_release_il', K_CONVERT/10)
Parameter('k_gdp_release_a', K_CONVERT)
Parameter('k_gdp_release_al', K_CONVERT)
# GTP binding
Parameter('k_gtp_bind_i', KF_BIND/10)
Parameter('k_gtp_bind_il', KF_BIND/10)
Parameter('k_gtp_bind_a', KF_BIND)
Parameter('k_gtp_bind_al', KF_BIND)
# release of Gbg
Parameter('k_gbg_release_i', K_CONVERT/10)
Parameter('k_gbg_release_il', K_CONVERT/10)
Parameter('k_gbg_release_a', K_CONVERT)
Parameter('k_gbg_release_al', K_CONVERT)
# release of Gaq:GTP
Parameter('k_gaq_release_i', K_CONVERT/10)
Parameter('k_gaq_release_il', K_CONVERT/10)
Parameter('k_gaq_release_a', K_CONVERT)
Parameter('k_gaq_release_al', K_CONVERT)
...
Rule('tat_bind_PAR2', TAT(b=None)**EXTRACELLULAR + PAR2(state='I', bortho=None, bgaq=None)**CELL_MEMB
     | tat_PAR2_i, kf_PAR2_i_bind_TAT,kr_PAR2_i_bind_TAT)
#    TAT:PAR2_I <---> TAT:PAR2_A
Rule('tat_activate_PAR2', tat_PAR2_i | tat_PAR2_a, k_activate_PAR2, k_inactivate_PAR2)
# R <---> R*
# PAR2_I <---> PAR2_A
equilibrate(PAR2(state='I', bortho=None,bgaq=None)**CELL_MEMB,
            PAR2(state='A', bortho=None,bgaq=None)**CELL_MEMB,
            [k_activate_PAR2_auto, k_inactivate_PAR2_auto])
#    2AT + PAR2_A <---> TAT:PAR2_A
Rule('tat_bind_PAR2_A', TAT(b=None)**EXTRACELLULAR + PAR2(state='A', bortho=None, bgaq=None)**CELL_MEMB
     | tat_PAR2_a, kf_PAR2_a_bind_TAT,kr_PAR2_a_bind_TAT)

# Gaq activation by activated-PAR2:
# Using the 5 step bi-ter Ping-Pong catalytic reaction cycle from
# Waelbroeck et al. 1997 J. theor. Biol. https://doi.org/10.1006/jtbi.1997.0411
##########
#### Inactive receptor
# (1) G protein recognition
#    PAR2_I + Gaq:GDP:Gbg ---> PAR2_I:Gaq:GDP:Gbg
PAR2_i = PAR2(state='I', bortho=None,bgaq=None)**CELL_MEMB
# Alias the complex PAR2_I:Gaq:GDP:Gbg
...
tat_PAR2_i_Gaq_gdp_Gbg = (TAT(b=1)**EXTRACELLULAR %
                          PAR2(state='I', bortho=1, bgaq=2)**CELL_MEMB %
                           ...
                           GDP(b=3)**CELL_MEMB % Gbg(b=4)**CELL_MEMB)
# free PAR2
Rule('par2_bind_gaq_i', PAR2_i + Gaq_gdp_Gbg >> PAR2_i_Gaq_gdp_Gbg,
     k_PAR2_bind_Gaq_i)
# bound PAR2
Rule('par2_bind_gaq_il', tat_PAR2_i + Gaq_gdp_Gbg >> tat_PAR2_i_Gaq_gdp_Gbg,
     k_PAR2_bind_Gaq_il)
# (2) GDP release
#    PAR2_I:Gaq:GDP:Gbg ---> PAR2_I:Gaq:Gbg + GDP
# Alias the complex  PAR2_i:Gaq:Gbg
PAR2_i_Gaq_Gbg = (PAR2(state='I', bortho=None, bgaq=2)**CELL_MEMB %
                  Gaq(bpar=2, bgdp=None, bgbg=4)**CELL_MEMB %
                  Gbg(b=4)**CELL_MEMB)
# Alias the complex  2AT:PAR2_A:Gaq:Gbg
tat_PAR2_i_Gaq_Gbg = (TAT(b=1)**EXTRACELLULAR %
                          PAR2(state='I', bortho=1, bgaq=2)**CELL_MEMB %
                           Gaq(bpar=2, bgdp=None, bgbg=4)**CELL_MEMB %
                           Gbg(b=4)**CELL_MEMB)
# free PAR2
Rule('gaq_releases_gdp_i', PAR2_i_Gaq_gdp_Gbg >> PAR2_i_Gaq_Gbg +
     GDP(b=None)**CYTOSOL, k_gdp_release_i)
# bound PAR2
Rule('gaq_releases_gdp_il', tat_PAR2_i_Gaq_gdp_Gbg >> tat_PAR2_i_Gaq_Gbg +
     GDP(b=None)**CYTOSOL, k_gdp_release_il)
# (3) GTP binding
#   PAR2_I:Gaq:Gbg + GTP ---> PAR2_I:Gaq:GTP:Gbg
# Alias the complex PAR2_I:Gaq:GTP:Gbg
PAR2_i_Gaq_gtp_Gbg = (PAR2(state='I', bortho=None, bgaq=2)**CELL_MEMB %
                      Gaq(bpar=2, bgdp=3, bgbg=4)**CELL_MEMB %
                      GTP(b=3)**CELL_MEMB % Gbg(b=4)**CELL_MEMB)
# Alias the complex 2AT:PAR2_I:Gaq:GTP:Gbg
tat_PAR2_i_Gaq_gtp_Gbg = (TAT(b=1)**EXTRACELLULAR %
                          PAR2(state='I', bortho=1, bgaq=2)**CELL_MEMB %
                           Gaq(bpar=2, bgdp=3, bgbg=4)**CELL_MEMB %
                           GTP(b=3)**CELL_MEMB % Gbg(b=4)**CELL_MEMB)
# free PAR2
Rule('gaq_binds_gtp_i', PAR2_i_Gaq_Gbg + GTP(b=None)**CYTOSOL >>
     PAR2_i_Gaq_gtp_Gbg, k_gtp_bind_i)
# bound PAR2
Rule('gaq_binds_gtp_il', tat_PAR2_i_Gaq_Gbg + GTP(b=None)**CYTOSOL >>
    tat_PAR2_i_Gaq_gtp_Gbg, k_gtp_bind_il)
# (4) Release of beta-gamma subunit
#    PAR2_I:Gaq:GTP:Gbg ---> PAR2_I:Gaq:GTP + Gbg
# Alias the complex PAR2_I:Gaq:GTP
PAR2_i_Gaq_gtp = (PAR2(state='I', bortho=None, bgaq=2)**CELL_MEMB %
                  Gaq(bpar=2, bgdp=3, bgbg=None)**CELL_MEMB %
                  GTP(b=3)**CELL_MEMB)
# Alias the complex 2AT:PAR2_A:Gaq:GTP
tat_PAR2_i_Gaq_gtp = (TAT(b=1)**EXTRACELLULAR %
                          PAR2(state='I', bortho=1, bgaq=2)**CELL_MEMB %
                           Gaq(bpar=2, bgdp=3, bgbg=None)**CELL_MEMB %
                           GTP(b=3)**CELL_MEMB)
# free PAR2
Rule('release_gbg_i', PAR2_i_Gaq_gtp_Gbg >>
                      PAR2_i_Gaq_gtp + Gbg(b=None)**CELL_MEMB,
                      k_gbg_release_i)
# bound PAR2
Rule('release_gbg_il', tat_PAR2_i_Gaq_gtp_Gbg >>
                       tat_PAR2_i_Gaq_gtp + Gbg(b=None)**CELL_MEMB,
                       k_gbg_release_il)
# (5) release of (activated) alpha-GTP
#    PAR2_I:Gaq:GTP ---> PAR2_I + Gaq:GTP
# Alias the complex Gaq:GTP
Gaq_gtp = (Gaq(bpar=None, bgdp=3, bgbg=None)**CELL_MEMB % GTP(b=3)**CELL_MEMB)
# free PAR2
Rule('release_gaq_i', PAR2_i_Gaq_gtp >> Gaq_gtp + PAR2_i, k_gaq_release_i)
# bound PAR2
Rule('release_gaq_il', tat_PAR2_i_Gaq_gtp >> Gaq_gtp + tat_PAR2_i,
                       k_gaq_release_il)
...
# Alias the complex PAR2_I:Gaq:GDP:Gbg
PAR2_a_Gaq_gdp_Gbg = (PAR2(state='A', bortho=None, bgaq=2)**CELL_MEMB %
                      Gaq(bpar=2, bgdp=3, bgbg=4)**CELL_MEMB %
                      GDP(b=3)**CELL_MEMB % Gbg(b=4)**CELL_MEMB)
# Alias the complex 2AT:PAR2_i:Gaq:GDP:Gbg
tat_PAR2_a_Gaq_gdp_Gbg = (TAT(b=1)**EXTRACELLULAR %
                          PAR2(state='A', bortho=1, bgaq=2)**CELL_MEMB %
                           ...
                           GDP(b=3)**CELL_MEMB % Gbg(b=4)**CELL_MEMB)
# free PAR2
Rule('par2_bind_gaq_a', PAR2_a + Gaq_gdp_Gbg >> PAR2_a_Gaq_gdp_Gbg,
     k_PAR2_bind_Gaq_a)
# bound PAR2
Rule('par2_bind_gaq_al', tat_PAR2_a + Gaq_gdp_Gbg >> tat_PAR2_a_Gaq_gdp_Gbg,
     k_PAR2_bind_Gaq_al)
# (2) GDP release
#    PAR2_I:Gaq:GDP:Gbg ---> PAR2_I:Gaq:Gbg + GDP
# Alias the complex  PAR2_i:Gaq:Gbg
PAR2_a_Gaq_Gbg = (PAR2(state='A', bortho=None, bgaq=2)**CELL_MEMB %
                  Gaq(bpar=2, bgdp=None, bgbg=4)**CELL_MEMB %
                  Gbg(b=4)**CELL_MEMB)
# Alias the complex  2AT:PAR2_A:Gaq:Gbg
tat_PAR2_a_Gaq_Gbg = (TAT(b=1)**EXTRACELLULAR %
                          PAR2(state='A', bortho=1, bgaq=2)**CELL_MEMB %
                           ...
                           Gbg(b=4)**CELL_MEMB)
# free PAR2
Rule('gaq_releases_gdp_a', PAR2_a_Gaq_gdp_Gbg >> PAR2_a_Gaq_Gbg +
     GDP(b=None)**CYTOSOL, k_gdp_release_a)
# bound PAR2
Rule('gaq_releases_gdp_al', tat_PAR2_a_Gaq_gdp_Gbg >> tat_PAR2_a_Gaq_Gbg +
     GDP(b=None)**CYTOSOL, k_gdp_release_al)
# (3) GTP binding
#   PAR2_A:Gaq:Gbg + GTP ---> PAR2_A:Gaq:GTP:Gbg
# Alias the complex PAR2_A:Gaq:GTP:Gbg
PAR2_a_Gaq_gtp_Gbg = (PAR2(state='A', bortho=None, bgaq=2)**CELL_MEMB %
                      Gaq(bpar=2, bgdp=3, bgbg=4)**CELL_MEMB %
                      GTP(b=3)**CELL_MEMB % Gbg(b=4)**CELL_MEMB)
...
tat_PAR2_a_Gaq_gtp_Gbg = (TAT(b=1)**EXTRACELLULAR %
                          PAR2(state='A', bortho=1, bgaq=2)**CELL_MEMB %
                           ...
                           GTP(b=3)**CELL_MEMB % Gbg(b=4)**CELL_MEMB)
# free PAR2
Rule('gaq_binds_gtp_a', PAR2_a_Gaq_Gbg + GTP(b=None)**CYTOSOL >>
     PAR2_a_Gaq_gtp_Gbg, k_gtp_bind_a)
# bound PAR2
Rule('gaq_binds_gtp_al', tat_PAR2_a_Gaq_Gbg + GTP(b=None)**CYTOSOL >>
    tat_PAR2_a_Gaq_gtp_Gbg, k_gtp_bind_al)
# (4) Release of beta-gamma subunit
#    PAR2_A:Gaq:GTP:Gbg ---> PAR2_A:Gaq:GTP + Gbg
# Alias the complex PAR2_I:Gaq:GTP
PAR2_a_Gaq_gtp = (PAR2(state='A', bortho=None, bgaq=2)**CELL_MEMB %
                  Gaq(bpar=2, bgdp=3, bgbg=None)**CELL_MEMB %
                  GTP(b=3)**CELL_MEMB)
# Alias the complex 2AT:PAR2_A:Gaq:GTP
tat_PAR2_a_Gaq_gtp = (TAT(b=1)**EXTRACELLULAR %
                          PAR2(state='A', bortho=1, bgaq=2)**CELL_MEMB %
                           ...
                           GTP(b=3)**CELL_MEMB)
# free PAR2
Rule('release_gbg_a', PAR2_a_Gaq_gtp_Gbg >>
                      PAR2_a_Gaq_gtp + Gbg(b=None)**CELL_MEMB,
                      k_gbg_release_a)
# bound PAR2
Rule('release_gbg_al', tat_PAR2_a_Gaq_gtp_Gbg >>
                       tat_PAR2_a_Gaq_gtp + Gbg(b=None)**CELL_MEMB,
                       k_gbg_release_al)
# (5) release of (activated) alpha-GTP
#    PAR2_A:Gaq:GTP ---> PAR2_A + Gaq:GTP
# Alias the complex Gaq:GTP
Gaq_gtp = (Gaq(bpar=None, bgdp=3, bgbg=None)**CELL_MEMB % GTP(b=3)**CELL_MEMB)
# free PAR2
Rule('release_gaq_a', PAR2_a_Gaq_gtp >> Gaq_gtp + PAR2_a, k_gaq_release_a)
# bound PAR2
Rule('release_gaq_al', tat_PAR2_a_Gaq_gtp >> Gaq_gtp + tat_PAR2_a,
                       k_gaq_release_al)
...
# Irreversible catalytic reaction as in yeast G protein cycle model
# of Yi et al. 2003 PNAS https://doi.org/10.1073/pnas.1834247100
...
Observable("aGaq_iib", tat_PAR2_i_Gaq_gtp)
Observable("aGaq_iic", PAR2_a_Gaq_gtp)
Observable("aGaq_iid", tat_PAR2_a_Gaq_gtp)
...
Expression('Kstar', k_activate_PAR2/k_inactivate_PAR2)
# Thermodynamic cycle from the full two-state activation of PAR2 - should be unity.
Expression('par2_thermo_cycle', Kstar * Kstar * (1/Kd_PAR2_i_bind_TAT) * (1/Kd_PAR2_a_bind_TAT))
# Get the FRET signal
