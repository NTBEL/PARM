...
Variant of parm.classic which incorporates noncompetitive antagonism via
negative allosteric modulation; however, the model could also be used model
...
Parameter('mod_factor', 2)
Expression('Kd_PAR2_bind_TAT_allo', Kd_PAR2_bind_TAT*mod_factor)
Expression('kr_PAR2_bind_TAT_allo', Kd_PAR2_bind_TAT_allo*kf_PAR2_bind_TAT)
...
tat_PAR2_i = TAT(b=1)**EXTRACELLULAR % PAR2(state='I', bortho=1, ballo=None, bgaq=None)**CELL_MEMB
tat_PAR2_a = TAT(b=1)**EXTRACELLULAR % PAR2(state='A', bortho=1, ballo=None, bgaq=None)**CELL_MEMB
#    2AT + PAR2_I <---> TAT:PAR2_I
Rule('tat_bind_PAR2', TAT(b=None)**EXTRACELLULAR + PAR2(state='I', bortho=None, ballo=None, bgaq=None)**CELL_MEMB
...
# Alias the Ant:PAR2 complex
Ant_PAR2_i = Ant(b=2)**EXTRACELLULAR % PAR2(state='I', bortho=None, ballo=2, bgaq=None)**CELL_MEMB
# nonompetitive binding of the Antoginst to an allosteric site
#   Ant + PAR2_I <---> Ant:PAR2_I
Rule('Ant_bind_PAR2', Ant(b=None)**EXTRACELLULAR + PAR2(state='I', bortho=None, ballo=None, bgaq=None)**CELL_MEMB
     | Ant_PAR2_i, kf_PAR2_bind_Ant,kr_PAR2_bind_Ant)
# Alias the Ant:PAR2:TAT complexes
Ant_PAR2_i_tat = Ant(b=2)**EXTRACELLULAR % PAR2(state='I', bortho=1, ballo=2, bgaq=None)**CELL_MEMB % TAT(b=1)**EXTRACELLULAR
Ant_PAR2_a_tat = Ant(b=2)**EXTRACELLULAR % PAR2(state='A', bortho=1, ballo=2, bgaq=None)**CELL_MEMB % TAT(b=1)**EXTRACELLULAR
#    2AT + PAR2_I:Ant <---> TAT:PAR2_I:Ant
Rule('tat_bind_PAR2_allo', TAT(b=None)**EXTRACELLULAR + Ant_PAR2_i
     | Ant_PAR2_i_tat, kf_PAR2_bind_TAT,kr_PAR2_bind_TAT_allo)
#    TAT:PAR2_I:Ant <---> TAT:PAR2_A:Ant
Rule('tat_activate_PAR2_allo', Ant_PAR2_i_tat | Ant_PAR2_a_tat, k_activate_PAR2, k_inactivate_PAR2)
# Assume that Ant can still bind PAR2 when 2AT is already bound and when PAR2 is active.
# Also assume that it does so with the same binding rates (and Kd).
#   Ant + PAR2_I:TAT <---> Ant:PAR2_I:TAT
Rule('Ant_bind_PAR2_i_ortho', Ant(b=None)**EXTRACELLULAR + tat_PAR2_i
     | Ant_PAR2_i_tat, kf_PAR2_bind_Ant,kr_PAR2_bind_Ant)
#   Ant + PAR2_A:TAT <---> Ant:PAR2_A:TAT
Rule('Ant_bind_PAR2_a_ortho', Ant(b=None)**EXTRACELLULAR + tat_PAR2_a
     | Ant_PAR2_a_tat, kf_PAR2_bind_Ant,kr_PAR2_bind_Ant)
...
tat_PAR2_a_Gaq_gdp_Gbg = (TAT(b=1)**EXTRACELLULAR %
                          PAR2(state='A', bortho=1, ballo=None, bgaq=3)**CELL_MEMB %
                           Gaq(bpar=3, bgdp=4, bgbg=5)**CELL_MEMB %
                           GDP(b=4)**CELL_MEMB % Gbg(b=5)**CELL_MEMB)

# Alias the complex 2AT:PAR2_A:Gaq:GDP:Gbg
tat_PAR2_a_Ant_Gaq_gdp_Gbg = (TAT(b=1)**EXTRACELLULAR %
                          PAR2(state='A', bortho=1, ballo=2, bgaq=3)**CELL_MEMB %
                          Ant(b=2)**EXTRACELLULAR %
                           Gaq(bpar=3, bgdp=4, bgbg=5)**CELL_MEMB %
                           GDP(b=4)**CELL_MEMB % Gbg(b=5)**CELL_MEMB)

# PAR2 binds the G protein heterotrimer
Rule('par2_bind_gaq', tat_PAR2_a + Gaq_gdp_Gbg | tat_PAR2_a_Gaq_gdp_Gbg,
     kf_PAR2_bind_Gaq,kr_PAR2_bind_Gaq)
Rule('par2_bind_gaq_allo', Ant_PAR2_a_tat + Gaq_gdp_Gbg | tat_PAR2_a_Ant_Gaq_gdp_Gbg,
     kf_PAR2_bind_Gaq,kr_PAR2_bind_Gaq)
...
tat_PAR2_a_Ant_Gaq_Gbg = (TAT(b=1)**EXTRACELLULAR %
                          PAR2(state='A', bortho=1, ballo=2, bgaq=3)**CELL_MEMB %
                          Ant(b=2)**EXTRACELLULAR %
                           Gaq(bpar=3, bgdp=None, bgbg=5)**CELL_MEMB %
                           Gbg(b=5)**CELL_MEMB)
...
Rule('gaq_releases_gdp_allo',tat_PAR2_a_Ant_Gaq_gdp_Gbg | tat_PAR2_a_Ant_Gaq_Gbg +
     GDP(b=None)**CYTOSOL, k_gdp_release, k_gdp_bind)
...
tat_PAR2_a_Gaq_gtp_Gbg = (TAT(b=1)**EXTRACELLULAR %
                          PAR2(state='A', bortho=1, ballo=None, bgaq=3)**CELL_MEMB %
                           Gaq(bpar=3, bgdp=4, bgbg=5)**CELL_MEMB %
                           GTP(b=4)**CELL_MEMB % Gbg(b=5)**CELL_MEMB)
tat_PAR2_a_Ant_Gaq_gtp_Gbg = (TAT(b=1)**EXTRACELLULAR %
                          PAR2(state='A', bortho=1, ballo=2, bgaq=3)**CELL_MEMB %
                          Ant(b=2)**EXTRACELLULAR %
                           Gaq(bpar=3, bgdp=4, bgbg=5)**CELL_MEMB %
                           GTP(b=4)**CELL_MEMB % Gbg(b=5)**CELL_MEMB)
...
Rule('gaq_binds_gtp_allo', tat_PAR2_a_Ant_Gaq_Gbg + GTP(b=None)**CYTOSOL |
    tat_PAR2_a_Ant_Gaq_gtp_Gbg, k_gtp_bind, k_gtp_release)

# Alias the complex 2AT:PAR2_A:Gaq:GTP
tat_PAR2_a_Gaq_gtp = (TAT(b=1)**EXTRACELLULAR %
                          PAR2(state='A', bortho=1, ballo=None, bgaq=3)**CELL_MEMB %
                           Gaq(bpar=3, bgdp=4, bgbg=None)**CELL_MEMB %
                           GTP(b=4)**CELL_MEMB)
tat_PAR2_a_Ant_Gaq_gtp = (TAT(b=1)**EXTRACELLULAR %
                          PAR2(state='A', bortho=1, ballo=2, bgaq=3)**CELL_MEMB %
                          Ant(b=2)**EXTRACELLULAR %
                           Gaq(bpar=3, bgdp=4, bgbg=None)**CELL_MEMB %
                           GTP(b=4)**CELL_MEMB)
...
Rule('release_gbg_allo', tat_PAR2_a_Ant_Gaq_gtp_Gbg >> tat_PAR2_a_Ant_Gaq_gtp + Gbg(b=None)**CELL_MEMB, k_gbg_release)
