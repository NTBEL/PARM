'''PARM: PAR2 Activation-driven calcium Release Model, classic, with competitive antagonism
...
Ant_PAR2_i = Ant(b=1)**EXTRACELLULAR % PAR2(state='I', bortho=1, bgaq=None)**CELL_MEMB
# Competitive binding of the Antoginst
#   Ant + PAR2_I <---> Ant:PAR2_I
Rule('Ant_bind_PAR2', Ant(b=None)**EXTRACELLULAR + PAR2(state='I', bortho=None, bgaq=None)**CELL_MEMB
